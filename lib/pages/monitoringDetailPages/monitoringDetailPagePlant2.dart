...
class MonitoringDetailPagePlant2 extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<List<Sensor>>(
          ...
          builder: (context, snapshot) {
            ...
            final newData =
                recentSensors.map((sensor) => sensor.data.last.plant2).toList();

            // final newSensor = sensorController.sensorsH.first.data.plant2;
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              Text(
                                                '${newData.last.kelembapanTanah.toDouble().toPrecision(0)}%',
                                                style: TextStyle(
                                                    fontSize: 20,
                                                    fontWeight:
                                                        FontWeight.bold),
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Column(
                                            ...
                                            children: <Widget>[
                                              Text(
                                                '${newData.last.suhu.toDouble().toPrecision(0)}\u00B0C',
                                                style: TextStyle(
                                                    fontSize: 20,
                                                    fontWeight:
                                                        FontWeight.bold),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            newData.last.suhu >= 30 ? "Panas" : "Dingin",
                            style: TextStyle(
                              fontSize: 20,
                              fontWeight: FontWeight.bold,
                            ),
                                  ...
                                  LineChartBarData(
                                    spots: recentData
                                        ...
                                        .map((entry) {
                                          return FlSpot(
                                            entry.key.toDouble(),
                                            entry.value.plant2.kelembapanTanah
                                                .toDouble()
                                                .toPrecision(0),
                                          );
                                        })
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "Suhu Tertinggi: ", //${newSensor.highestTemperature}°C",
                            style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                              fontSize: 18,
